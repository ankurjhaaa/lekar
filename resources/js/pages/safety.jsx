        ...
        <PublicLayout>
            ...
            <div className="bg-white min-h-screen pb-24">
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center min-h-[50vh]">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2">Safety Centre</h2>
                    <p className="text-gray-500 text-sm">Your safety is our priority. Emergency contacts and features.</p>
                </div>
