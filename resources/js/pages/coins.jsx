        ...
        <PublicLayout>
            ...
            <div className="bg-white min-h-screen pb-24">
                <div className="sticky top-0 z-10 bg-white px-4 py-4 border-b border-gray-100 flex items-center gap-4 shadow-sm">
                    ...
                    <h1 className="text-xl font-bold text-gray-900">Lekar Coins</h1>
                </div>
                ...
                <div className="flex flex-col items-center justify-center p-8 text-center min-h-[50vh]">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2">My Coins</h2>
                    <p className="text-gray-500 text-sm">Track and redeem your earned coins.</p>
                </div>
